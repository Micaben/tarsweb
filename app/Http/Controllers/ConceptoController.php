...
class ConceptoController extends Controller
{
    ...
    {
        $mot = Conceptoventa::select(['conceptoventa.id', 'conceptoventa.descripcion', 'conceptoventa.cortesia', 'conceptoventa.detalle', 'conceptoventa.kardex', 'conceptoventa.nogravada' ,'documentos.descripcion  as nombre_comprobante','conceptoventa.codAfec as codAfec','conceptoventa.Tabla17 as tipoperacion','conceptoventa.Tabla51 as typecode'])
