                                ...
                                <div class="d-flex justify-content-between">
                                    <div class="margin">
                                        ...
                                        <button class="btn btn-primary btn-icon-split btn-sm" style="margin-top: 10px;"
                                            ...
                                            data-url="{{ route('listar-mostrarRegistrosCotizacion') }}"
                                            data-route-name="registroCotizacion"
                                            data-routedetalle-name="registroCotizaciondetalle"
                                            ...
                                            data-input-mapping='{"cboserie":"seriecot", "numeronota":"numcot", "fechaproceso":"FechaCot", "cboconcepto":"Concepto", "cboproveedor":"ruc", "proveedor":"ruc", "cbomoneda":"Moneda", "vigencia":"Validez", "ordencompra":"OCompra", "cboalmacen":"almacen","comentarios":"Referencia", "iddeldocumento":"id", "subtotal":"baseimp","inigv":"in_igv", "igv":"igv","lblmoneda":"Factor2", "totalSuma":"Total"}'
                                        ...
                                        <div class="btn-group" style="margin-top: 10px;">
                                            <button data-input="proveedor" class="btn btn-primary btn-icon-split btn-sm"
                                                data-toggle="modal" data-target="#modal-agregar-transporte"
                                                data-blade-id="transporte"><span class="icon text-white-50"><i
                                                        class="far fa-file"></i></span><span
                                                    class="text">Cuotas</span></button>
                                        </div>
                                        <div class="btn-group" style="margin-top: 10px;">
                                            <button class="btn btn-primary btn-icon-split btn-sm"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">                                            
                                            ...
                                            <div class="form-group col-sm-2 mb-2">
                                                ...
                                                <select class="form-control form-control-sm" required=""
                                                    id="cbocomprobante" name="cbocomprobante">
                                                </select>
                                            </div>
    ...
    <script>
        ...
        function registrar(event) {
            ...
            fetch('/guardar-guiaremision', {
                ...
                .then(data => {
                    if (data.success) {
                        showSuccessMessage('Operación exitosa: ' + (data.message ? data.message :
        ...
        $(document).ready(function () {
            $('#btnAbrirModalTransporte').on('click', function (event) {
                // Evitar la acción predeterminada (abrir el modal) por ahora
                event.preventDefault();

                // Obtener el valor del input 'ructransporte'
                var rucValue = $('#proveedor').val();

                // Verificar si el valor está vacío
                if (!rucValue) {
                    // Mostrar la alerta usando Swal
                    showErrorMessage('Elija un cliente !!');
                } else {
                    // Si no está vacío, abrir el modal
