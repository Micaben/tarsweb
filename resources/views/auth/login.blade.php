          ...
          <div class="card-body p-4 p-sm-5">
            ...
            <form action="{{ route('login.custom') }}" id="loginform" method="post">
              ...
              <div class="form-floating mb-3">
                ...
                <input type="text" class="form-control" required id="usuarioinput" name="usuario"
                  placeholder="juanperez">
              </div>
              <div class="form-floating mb-3">
                <label class="my-0" for="password">Password:</label>
                <input type="password" class="form-control" required id="passwordinput" name="password"
