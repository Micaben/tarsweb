...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="row">
                            <div class="col-12">
                                <form id="form-pedidos" method="POST" action="{{ url('guardar-pedidos') }}">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="margin">
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<div class="btn-group"
                                            ...
                                            <button class="btn btn-primary btn-icon-split btn-sm"
                                                ...
                                                data-target="#modal-mostrar-registros" data-columns='[{"name": "Documento", "align": "left"},
                                                            {"name": "Fecha", "align": "left"},
                                                            {"name": "RUC", "align": "left"},
                                                            {"name": "Cliente", "align": "left"},
                                                            {"name": "O/Compra", "align": "left"},
                                                            {"name": "Estado", "align": "center"},
                                                            {"name": "MDA", "align": "center"},
                                                            {"name": "Total", "align": "right"},
                                                            {"name": "id", "align": "center"}]'
                                                data-url="{{ route('listar-mostrarRegistrosPedidos') }}"
                                                data-route-name="registroPedido"
                                                data-routedetalle-name="registroPedidodetalle"
                                                data-inputs='["cboserie", "numeronota", "fechaproceso", "cboconcepto", "cboproveedor", "proveedor", "cbomoneda","cbocondicion","cbovendedor","ordencompra","cboalmacen","comentarios","iddeldocumento","subtotal","inigv","igv","lblmoneda","totalSuma"]'
                                                data-input-mapping='{"cboserie":"serie", "numeronota":"numero", "fechaproceso":"Fecha", "cboconcepto":"Concepto", "cboproveedor":"ruc", "proveedor":"ruc", "cbomoneda":"Moneda", "cbocondicion":"condicion","cbovendedor":"Vendedor", "ordencompra":"OCompra", "cboalmacen":"almacen","comentarios":"Referencia", "iddeldocumento":"id", "subtotal":"baseimp","inigv":"in_igv", "igv":"igv","lblmoneda":"Factor2", "totalSuma":"Total"}'
                                            ...
                                            <div class="btn-group" style="margin-top: 10px;">
                                                <button class="btn btn-primary btn-icon-split btn-sm" id="btnImprimir"
                                                    name="btnImprimir" onclick="imprimirReporte()"><span
                                                        class="icon text-white-50"><i
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input id="tipodocumento" name="tipodocumento" type="hidden"
                                            class="form-control form-control-sm" value="N1" readonly="">
                                        <div class="row">
                                        ...
                                        <div class="mb-2">
                                            <button type="button" id="btnAgregar" name="btnAgregar" value="Agregar"
                                                ...
                                                data-target="#modal-agregar-producto" data-blade-id="pedidos">
    ...
    <script>
        $(document).ready(function () {
            ...
            listarOpciones("#cboserie", "{{ route('obtener-series', ['id' => 'N1']) }}", 'id', 'serie', true);
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (cboSerie) {
                cboSerie.addEventListener('change', function () {
                    ...
                    var url = "{{ url('obtener-ultimonumero') }}/N1/" + encodeURIComponent(valorSeleccionado);
        ...
        function modalNuevoRegistro() {
            ...
            document.getElementById("tipodocumento").value = 'N1';
