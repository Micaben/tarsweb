                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="form-group col-sm-2 mb-2">
                                    ...
                                    <input id="codproducto" type="text" class="form-control custom-button form-control-sm"
                                        name="codproducto" maxlength="10" required="">
                                </div>
                                <div class="form-group col-sm-4 mb-2">
                                    <label class="my-0">Descripcion:</label>
                                    <input id="descripcion" type="text" class="form-control custom-button form-control-sm"
                                        name="descripcion" maxlength="10" required="">
                                </div>
                                <div class="form-group col-sm-2 mb-2">
                                    <label class="my-0">Codigo de barras:</label>
                                    <input id="codbarras" type="text" class="form-control custom-button form-control-sm"
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#modal-agregar-producto').on('show.bs.modal', function (event) {
                ...
                cargartabla(url, bladeId);
            });
        });

        function cargartabla(url, bladeId) {
            var columnConfigLaravel = [
                { name: "codProducto", title: "<div style='text-align: center;'>Codigo</div>", type: "text", width: 40 },
                ...
                { name: "Ancho", title: "<div style='text-align: center;'>Ancho</div>", type: "text", width: 30, align: "center" },
                { name: "saldo", title: "<div style='text-align: center;'>Stock</div>", type: "text", align: "right"},
            ];
            inicializarTabla(url, columnConfigLaravel, 'tablaListaProductos', 'modal-agregar-producto', bladeId);
        }

        function inicializarTabla(url, columnConfig, tablaID, modalID, bladeId) {
            hacerConsulta(url, columnConfig, tablaID, modalID, bladeId);
        }
