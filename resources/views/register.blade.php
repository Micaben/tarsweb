                ...
                <div class="row">
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form id="registrationForm" class="user" action="{{ url('register') }}" method="POST">
                                @csrf
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="name" required
                                            name="name" placeholder="First Name">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-user" id="usuario" required
                            ...
                            <div class="text-center">
                                <a class="small" href="{{ route('custom-login-root') }}">Already have an account? Login!</a>
                            </div>
                        </div>
                    </div>
                </div>
