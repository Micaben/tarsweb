...
Route::post('/anularRegistroCotizacion/{id}',  [VentasCotizacionController::class, 'anularRegistroCotizacion'])->name('anularRegistroCotizacion');
...
Route::get('/mostrarRegistrosPedidos', [VentasGuiaremisionController::class, 'mostrarRegistrosPedidos'])->name('listar-mostrarRegistrosPedidos');
Route::get('/buscarRegistroPedido/{id}', [VentasGuiaremisionController::class, 'buscarregistroPedido'])->name('buscar-registroPedido');
Route::get('/buscarDetallePedido/{id}', [VentasGuiaremisionController::class, 'buscardetallePedido'])->name('buscar-detallePedido');
Route::post('/anularRegistro/{id}',  [VentasGuiaremisionController::class, 'anularRegistro'])->name('anularRegistro');

Route::get('/ventas-mes/dolares/{mes}', [VentasPedidosController::class, 'obtenerVentasPorMesDolares']);
Route::get('/ventas-mes/soles/{mes}', [VentasPedidosController::class, 'obtenerVentasPorMesSoles']);